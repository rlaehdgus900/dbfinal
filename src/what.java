...
public class what {
	...
	/************************************************************************************************************************
	* openAPI에서 315개의 tuple 가져오기
	*************************************************************************************************************************/

	public static class ApiExplorer{
		public void apiexplorer(String SIGUN_CD) throws IOException {
			StringBuilder urlBuilder = new StringBuilder("https://openapi.gg.go.kr/MrktStoreM");
			urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8") + "=0535a6471c7b4d8a9920c4c5830a3c98");
			...
			urlBuilder.append("&" + URLEncoder.encode("SIGUN_CD", "UTF-8") + "=" + URLEncoder.encode(SIGUN_CD, "UTF-8"));
